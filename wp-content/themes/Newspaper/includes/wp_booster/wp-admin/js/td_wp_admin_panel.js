...
function td_ajax_form_submit() {
    ...
    jQuery('#td_button_save_panel').click(function(event){
        ...
        if (typeof tdPanelVueComponents !== 'undefined') {
            for (let componentName in tdPanelVueComponents) {
                if (Object.hasOwnProperty.call(tdPanelVueComponents, componentName)) {
                    let componentData = tdPanelVueComponents[componentName].getData();
